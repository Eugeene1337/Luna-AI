...
export const deployTokenContractAction: Action = {
    ...
    validate: async (runtime: IAgentRuntime, _message: Memory) => {
        lunaLogger.log("Validating runtime for DEPLOY_TOKEN_CONTRACT...");
        return (
            !!(
    ...
    handler: async (
        ...
        lunaLogger.log("Starting DEPLOY_TOKEN_CONTRACT handler...");
        ...
        try {
            ...
            lunaLogger.log("Contract details:", contractDetails.object);
            ...
            await contract.wait();
            lunaLogger.log("Deployment details:", deploymentDetails);
            lunaLogger.log("Contract deployed successfully:", contract);
...
Contract deployment has been logged to the CSV file.`,
            ...
            lunaLogger.error("Error deploying token contract:", error);
            callback(
                {
...
export const invokeContractAction: Action = {
    ...
    validate: async (runtime: IAgentRuntime, _message: Memory) => {
        lunaLogger.log("Validating runtime for INVOKE_CONTRACT...");
        return (
            !!(
                runtime.character.settings.secrets?.COINBASE_API_KEY ||
                process.env.COINBASE_API_KEY
    ...
    handler: async (
        ...
        lunaLogger.log("Starting INVOKE_CONTRACT handler...");
        ...
        try {
            ...
            lunaLogger.log("Invocation details:", invocationDetails.object);
            ...
            lunaLogger.log("Invocation options:", invocationOptions);
            // Invoke the contract
...
Contract invocation has been logged to the CSV file.`,
            ...
            lunaLogger.error("Error invoking contract method:", error);
            callback(
                {
...
export const readContractAction: Action = {
    ...
    validate: async (runtime: IAgentRuntime, _message: Memory) => {
        lunaLogger.log("Validating runtime for READ_CONTRACT...");
        return (
            !!(
                runtime.character.settings.secrets?.COINBASE_API_KEY ||
                process.env.COINBASE_API_KEY
    ...
    handler: async (
        ...
        lunaLogger.log("Starting READ_CONTRACT handler...");
        ...
        try {
            ...
            const { contractAddress, method, args, networkId, abi } =
                readDetails.object;
            lunaLogger.log("Reading contract:", {
                contractAddress,
                method,
                args,
                networkId,
            ...
            lunaLogger.info("Contract read result:", serializedResult);
...
- Result: ${JSON.stringify(serializedResult, null, 2)}`,
            ...
            lunaLogger.error("Error reading contract:", error);
            callback(
                {
