...
export const tradeProvider: Provider = {
    get: async (runtime: IAgentRuntime, _message: Memory) => {
        try {
            ...
            lunaLogger.log("Reading CSV file from:", tradeCsvFilePath);
...
export const executeTradeAction: Action = {
    ...
    validate: async (runtime: IAgentRuntime, _message: Memory) => {
        lunaLogger.log("Validating runtime for EXECUTE_TRADE...");
        return (
            !!(
    ...
    handler: async (
        ...
        lunaLogger.log("Starting EXECUTE_TRADE handler...");
...
- Charity Transaction URL: ${transfer.getTransactionLink() || ""}`;
            ...
            lunaLogger.error("Error during trade execution:", error);
            callback(
                {
