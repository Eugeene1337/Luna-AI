...
export const createCoinbaseChargeAction: Action = {
    ...
    handler: async (
        ...
        lunaLogger.log("Charge details received:", chargeDetails);
...
export const getAllChargesAction: Action = {
    ...
    handler: async (
        ...
        try {
            ...
            lunaLogger.log("Fetched all charges:", charges);
            ...
            lunaLogger.error("Error fetching all charges:", error);
            callback(
                {
...
export const getChargeDetailsAction: Action = {
    ...
    handler: async (
        ...
        try {
            ...
            lunaLogger.log("Fetched charge details:", chargeDetails);
...
export const chargeProvider: Provider = {
    get: async (runtime: IAgentRuntime, _message: Memory) => {
        ...
        lunaLogger.log("Charges:", formattedCharges);
