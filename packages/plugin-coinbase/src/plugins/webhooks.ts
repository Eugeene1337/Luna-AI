...
export const webhookProvider: Provider = {
    get: async (runtime: IAgentRuntime, _message: Memory) => {
        try {
            ...
            lunaLogger.log("Listing all webhooks:", resp.data);
            ...
            lunaLogger.error("Error in webhookProvider:", error);
            return [];
        }
    },
};
...
export const createWebhookAction: Action = {
    ...
    validate: async (runtime: IAgentRuntime, _message: Memory) => {
        lunaLogger.log("Validating runtime for CREATE_WEBHOOK...");
        return (
            !!(
    ...
    handler: async (
        ...
        lunaLogger.log("Starting CREATE_WEBHOOK handler...");
        ...
        try {
            ...
            lunaLogger.log("Creating webhook with details:", {
                networkId,
                notificationUri,
                eventType,
                eventTypeFilter,
            ...
            lunaLogger.log("Webhook appended to CSV successfully");
        } catch (error) {
            lunaLogger.error("Error during webhook creation:", error);
            callback(
                {
