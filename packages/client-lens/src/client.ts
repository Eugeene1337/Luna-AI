...
export class LensClient {
    ...
    async authenticate(): Promise<void> {
        try {
            ...
            lunaLogger.error("client-lens::client error: ", error);
            throw error;
        }
    }
    ...
    async createPublication(
        ...
        try {
            if (!this.authenticated) {
                ...
                lunaLogger.log("done authenticating");
            }
            let broadcastResult;
            ...
            lunaLogger.log("broadcastResult", broadcastResult);
    ...
    async getProfile(profileId: string): Promise<Profile> {
        ...
        if (!result?.id) {
            lunaLogger.error("Error fetching user by profileId");
