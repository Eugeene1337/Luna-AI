class lunaLogger {
    constructor() {
        ...
        console.log(`[lunaLogger] Initializing with:
            isNode: ${this.isNode}
    ...
    debug(...strings) {
        if (!this.verbose) {
            ...
            // console.log(
            //     "[lunaLogger] Debug message suppressed (verbose=false):",
            //     ...strings
            // );
            return;
        }
...
export const lunaLogger = new lunaLogger();
lunaLogger.closeByNewLine = true;
lunaLogger.useIcons = true;

export default lunaLogger;
