import { lunaLogger, Client, IAgentRuntime, Plugin } from "@luna/core";
...
export const EchoChamberClientInterface: Client = {
    async start(runtime: IAgentRuntime) {
        try {
            ...
            lunaLogger.log("Starting EchoChambers client...");
            ...
            lunaLogger.error("Failed to start EchoChambers client:", error);
            throw error;
        }
    },
    ...
    async stop(runtime: IAgentRuntime) {
        try {
            lunaLogger.warn("Stopping EchoChambers client...");
            ...
            lunaLogger.success("EchoChambers client stopped successfully");
        } catch (error) {
            lunaLogger.error("Error stopping EchoChambers client:", error);
            throw error;
        }
    },
};
