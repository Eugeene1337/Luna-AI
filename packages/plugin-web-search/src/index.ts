...
import { generateWebSearch } from "@luna/core";
import { SearchResult } from "@luna/core";
...
const webSearch: Action = {
    ...
    handler: async (
        ...
        lunaLogger.log("web search prompt received:", webSearchPrompt);

        lunaLogger.log("Generating image with prompt:", webSearchPrompt);
        ...
        if (searchResponse && searchResponse.results.length) {
            ...
            lunaLogger.error("search failed or returned no data.");
        }
    },
    examples: [
        [
