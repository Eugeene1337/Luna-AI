...
import { stringToUuid, getEmbeddingZeroVector } from "@luna/core";
import {
    ChannelType,
    Client,
...
export class MessageManager {
    ...
    private async _shouldIgnore(message: DiscordMessage): Promise<boolean> {
        ...
        // short responses where luna should stop talking and disengage unless mentioned again
        if (
    ...
    private async _shouldRespond(
        ...
        try {
            ...
            lunaLogger.error("Error in _shouldRespond team processing:", {
                error,
                agentId: this.runtime.agentId,
