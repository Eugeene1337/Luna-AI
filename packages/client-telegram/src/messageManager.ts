...
import { composeContext, lunaLogger, ServiceType } from "@luna/core";
import { getEmbeddingZeroVector } from "@luna/core";
import {
    Content,
    HandlerCallback,
    IAgentRuntime,
...
import { stringToUuid } from "@luna/core";

import { generateMessageResponse, generateShouldRespond } from "@luna/core";
import { messageCompletionFooter, shouldRespondFooter } from "@luna/core";
...
export class MessageManager {
    ...
    private async processImage(
        ...
        try {
            ...
            lunaLogger.info(`Telegram Message: ${message}`);
    ...
    private async sendImage(
        ...
        try {
            ...
            lunaLogger.info(`Image sent successfully: ${imagePath}`);
        } catch (error) {
            lunaLogger.error("Error sending image:", error);
        }
    }
    ...
    public async handleMessage(ctx: Context): Promise<void> {
        ...
        try {
            ...
            lunaLogger.error("Error sending message:", error);
        }
    }
}
