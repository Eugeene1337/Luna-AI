...
export class GetAvailableLicensesAction {
    ...
    async getAvailableLicenses(
        ...
        try {
            ...
            lunaLogger.log("licenseDetailsResponse", licenseDetailsResponse);
            return licenseDetailsResponse;
        } catch (e) {
            lunaLogger.error("Failed to parse response");
...
export const getAvailableLicensesAction = {
    ...
    handler: async (
        ...
        lunaLogger.log("Starting GET_AVAILABLE_LICENSES handler...");
        ...
        try {
            ...
            lunaLogger.error("Error fetching available licenses:", e.message);
            callback?.({
