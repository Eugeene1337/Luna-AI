import { composeContext, lunaLogger } from "@luna/core";
import { generateMessageResponse, generateTrueOrFalse } from "@luna/core";
import { booleanFooter, messageCompletionFooter } from "@luna/core";
import {
    Action,
    ActionExample,
    Content,
...
export const continueAction: Action = {
    ...
    handler: async (
        ...
        if (!shouldContinue) {
            lunaLogger.log("Not elaborating, returning");
            return;
        }
